...
type Aviso = { archivo: string; linea: number; tabla: string; consulta: string }
...
*/
function laConsulta(lineas: string[], desde: number): string {
...
const porArchivo = new Map<string, Aviso[]>()
