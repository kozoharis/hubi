...
export default function Grabar({
  ...
  */
  ...
  return (
    <main
      className="techo relative min-h-dvh overflow-hidden px-6 pb-8"
...
/* La conversión a WAV vivía aquí, y el micrófono de la cocina no la
   usaba porque no podía: era una función privada de este archivo. Se
   ha ido entera a `lib/a-wav.ts`, que es donde la ven los dos. El
   porqué largo está allí. */
